...
export function Login ({}: Props) {
    return (
        <>
            <button className="h-10 z-10 fixed w-[100px] top-0 right-0 mt-3 mr-4 text-white font-bold rounded-lg bg-[#c72931]">Register</button>
            <div className="h-screen relative overflow-hidden flex justify-center items-center w-screen bg-[url('/login-banner.jpg')] bg-cover bg-no-repeat">
                <div className="w-[400px] min-h-[350px] flex flex-col justify-center items-center rounded-3xl backdrop-blur-sm bg-[#ffffff]/40  mx-4 z-10 px-6 py-4 bg-white">
                    ...
                    <p className="text-[#303a40] font-bold text-sm">*Please register if you are a new user to begin your journey.</p>            
                </div>
